                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <section id="pct-section-content">
                            ...
                            <!--說明For RD: 判別是否成為P-Mall賣家，如果有，新增Alert。 start-->
                                <div class="msgbar">
                                    <div class="alert">
                                      <span class="pct-icon icon-delete" onclick="this.parentElement.style.display='none';"></span> 
                                      恭喜您已經成為P-Mall賣家，請選擇優先曝光商品，即可優先曝光於首頁。
                                    </div>
                                </div>
                            <!--說明For RD: 判別是否成為P-Mall賣家，如果有，新增Alert。 end--> 
                             ...
                             <div class="searchBarGroup">
                                <!-- 商品搜尋開始-->
                                        ...
                                        <div class="pct-ui form inputGroup">
                                            ...
                                            <a href="demo-product-clearsearch.php" class="pct-ui btn-sm btn-cta inputGroup-btn">搜尋</a>
                                        </div>
                                <!-- 商品搜尋結束-->  
                            ...
                            <div class="product-list-statistics">
                                ...
                                <div class="product-list-statistics-btnGroup">
                                    ...
                                    <!--說明For RD: 判別是否在”全部商品“或“上架商品”的狀態tab，如果是，新增按鈕“加入曝光” start-->
                                    <a href="#" class="pct-ui btn-xs btn-cta ">加入曝光</a>
                                    <!--說明For RD: 判別是否在”全部商品“或“上架商品”的狀態tab，如果是，新增按鈕“加入曝光” end-->

                                    <a href="#" class="pct-ui btn-xs btn-cta sellAllBtn"><!-- All List --> <!-- ชั้นวางทั้งหมด --> 全部上架</a>
                            ...
                            <div class="pct-ui tab-nav-bar tab-nav tab-nav-fluid">
                                <div class="pct-ui tab-pointing">
                                    <ul class="tab-items no-margin">
                                        <li><a href="#tab1" class="active"><!-- คำสั่งซื้อทั้งหมด --> 全部商品 (15)</a></li>
                                        <li><a href="#tab2"><!-- คำสั่งซื้อทั้งหมด --> 上架商品 (5)</a></li>
                                        <li><a href="#tab3"><!-- รอการจัดส่ง --> 無庫存 (4)</a></li>
                                        <li><a href="#tab4"><!-- อยู่ระหว่างการขนส่ง -->下架商品 (3)</a></li>
                                        <li><a href="#tab4">待上架 (93)</a></li>

                                        <!--說明For RD: 新增標籤tab“優先曝光” start-->
                                        <li><a href="#tab5">優先曝光</a></li>
                                        <!--說明For RD: 新增標籤tab“優先曝光” end-->
                                        ...
                                        <div class="pct-ui card-edit-add">
                                                <div class="card-edit-info">
                                                    ...
                                                    <div class="card-content">
                                                       <div class="add-to-list"><span class="pct-icon icon-plus"></span></div>
                                ...
                                <div class="block-grid-2-4">
                                    <div class="pct-ui card-edit">
                                        ...
                                        <a onclick="location.href='product-edit.php'" class="pct-item-card-link">
                                            <div class="card-edit-info">
                                                <div class="card-figure">
                                                    <div class="delete-btn edit-btn"><li class="pct-icon icon-trash"></li></div>
                                                    <div class="card-figure-inner">
                                        ...
                                        <div class="card-edit-action">
                                            ...
                                            <a href="https://www.pchome.co.th/pro/content/show/3031804163971" target="blank" class="previewProductBtn"> <span class="pct-icon icon-preview"></span>預覽</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="block-grid-2-4">
                                ...
                                <div class="block-grid-2-4">
                                    <div class="pct-ui card-edit">
                                        ...
                                        <div class="card-edit-action">
                                            ...
                                            <a href="https://www.pchome.co.th/pro/content/show/3031804163971" target="blank" class="previewProductBtn"> <span class="pct-icon icon-preview"></span>Preview</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="block-grid-2-4">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <div class="card-content-pricestock eng-num">
                                                        <div class="current-stock">
                                                            <div class="replen-stock-block"> <span class="pct-icon icon-alert"></span> <!-- 補庫存再賣 -->  Refill to sell</div>
                                                            庫存 <span>0</span>
                                                        </div>
                                                        <div class="current-price"><span>฿</span>1,620</div>
                                                    </div>
                                ...
                                <div class="block-grid-2-4">
                                    <div class="pct-ui card-edit">
                                            ...
                                            <div class="card-edit-info">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <div class="card-content-pricestock">
                                                        <div class="current-stock">สินค้าเหลือ<span class="eng-num">499</span></div>
                                        ...
                                        <div class="card-edit-action">
                                            ...
                                            <a href="https://www.pchome.co.th/pro/content/show/3031804163971" target="blank" class="previewProductBtn"> <span class="pct-icon icon-preview"></span>ลบ</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="block-grid-2-4">
                                        ...
                                        <a href="product-edit.php" class="pct-item-card-link">
                                            <div class="card-edit-info">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <div class="card-content-pricestock eng-num">
                                                        <div class="current-stock">
                                                            <div class="replen-stock-block"> <span class="pct-icon icon-alert"></span> 補庫存再賣</div>
                                                            庫存 <span>0</span></div>
                                                        <div class="current-price"><span>฿</span>1,620</div>
                                                    </div>
                                                    <div class="card-footer">
                            ...
                            <!--商品格子內容區P-mall start-->
                            <!--說明For RD: 判別tab如果在“優先曝光”時,每張商品卡片要刪除垃圾桶icon <div class="delete-btn edit-btn"><li class="pct-icon icon-trash"></li></div> -->
                            <div class="grid-content">
                            ...
                            <div class="pct-ui page-pagination hidden-sm-down">
                                <ul class="eng-num">
                                    ...
                                    <li><a href="#">50</a></li>
                                    <li><a class="pagination-next" href="#"><span class="pct-icon icon-angle-right"></span></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="action-bar-wrap">
                                    ...
                                    <div class="action-btn-box">
                                        ...
                                        <a href="#" class="pct-ui btn btn-cta js-pct-panel-trigger action-btn-box-batchedit" data-panel="batchedit">
                                            <span class="pct-icon icon-edit hidden-xxs-up"></span>
                                            <span class="hidden-xxs-down">大量編輯</span>
                                        </a>

                                        <!-- 說明For RD: 若是tab在優先曝光的狀態 也點選裡面商品 即可出現-->
                                        <a href="#" class="pct-ui btn ">移出曝光</a>
