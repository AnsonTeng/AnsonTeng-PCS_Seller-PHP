                                ...
                                <div class="content-description">
                                    ...
                                    <div class="sea-ui form-label product-category form-m-break">
                                        ...
                                        <div class="column-form">
                                            ...
                                            <div class="sea-ui form select" style="display: none">
                                                <select>
                                                    <option value="0">請選擇</option>
                                    ...
                                    <!-- <div class="exchangeRate">
                                        <span class="form-introduction">按照每日浮動匯率計算<span>美金</span>價格 參考匯率：<span>29.991</span><span>(DD/MM/YYYY)</span>
                                        </span>
                                    </div> -->
                                            ...
                                            <div class="accordion-caption">
                                                <div class="caption-inner">
                                                    ...
                                                    <div class="caption-title-group">
                                                        ...
                                                        <div class="caption-note">不支援</div>
                                                    </div>
                                                </div>
                                                <div class="caption-switch">
                                                    <div class="sea-ui form-label">
                                                ...
                                                <div class="liquid-container-inner">
                                                    <ul class="shipnotice">
                                                        <li>
                                                            ...
                                                            <span class="note">泰國部分郵遞區號為 9 開頭的地區，可能無法支援配送。包括但不限於 Song Khla, Stoon, Trang, Pattalung, Pattani, Yala, Naratiwat 等區。</span>
                                                        </li>
                                                        <li>重量限制: <span class="highlight"> 30kg以下 </span></li>
                                    ...
                                    <div class="logistic-wrap seller">
                                        ...
                                        <div class="sea-ui accordion">
                                            ...
                                            <div class="accordion-caption">
                                                ...
                                                <div class="caption-text-box">
                                                    <div class="caption-text-box"> $ 500 <a class="sea-seller-icon icon-edit editshippingBtn"></a></div>
                                                </div>
                                            </div>
