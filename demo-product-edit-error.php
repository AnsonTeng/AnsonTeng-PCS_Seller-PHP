...
<body>
                                            ...
                                            <div id="thai">
                                                ...
                                                <div class="pct-ui form-textarea-label fluid form-m-break">
                                                    ...
                                                    <div class="pct-ui form error">
                                                        ...
                                                        <div class="error-notification-tooltip-inline">商品描述為必填且不可超過150字元
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="pct-ui form-label volumatic">
                                        ...
                                        <div class="column-form">
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                ...
                                                <div class="error-notification-tooltip-inline">請輸入材積長
                                                    <!-- or 單邊數值需大於0cm -->
                                                </div>
                                            </div>
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                <input type="text" placeholder="寬">
                                                <div class="error-notification-tooltip-inline">請輸入材積寬
                                                    <!-- or 單邊數值需大於0cm -->
                                                </div>
                                            </div>
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                <input type="text" placeholder="高">
                                                <div class="error-notification-tooltip-inline">請輸入材積高
                                                    <!-- or 單邊數值需大於0cm -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <!--商品管理 JS-->
    <script type="text/javascript" src="js/js_prouct.js"></script>
    <script>
