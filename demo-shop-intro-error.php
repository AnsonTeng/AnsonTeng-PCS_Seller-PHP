                                ...
                                <div class="content-description">
                                    <div class="form-column">
                                        ...
                                        <div class="sea-ui form checkbox">
                                            ...
                                            <input type="checkbox" id="Thailand" name="checkGroup" value="1">
                                            <label for="Thailand">
                                                <span>泰國</span>
                                            </label>
                                        </div>
                                    ...
                                    <span class="error-notification-tooltip-inline" style="display:block"><span class="sea-seller-icon icon-alert"></span>至少選擇一個國家</span>
                                </div>
                            </div>
