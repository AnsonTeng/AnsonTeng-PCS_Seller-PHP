                        ...
                        <section id="sea-section-content">
                            ...
                            <div class="sea-ui tab-nav-bar">
                                <div class="sea-ui tab-pointing">
                                    <ul class="tab-items">
                                        <li><a href="#" class="active">全部通知 (130)</a></li>
                                        <li><a href="#">未讀通知 (7)</a></li>
                            ...
                            <div class="notification-read-all">
                                <a href="#" class="sea-ui btn-sm btn-primary btn-read-all"><span class="sea-btn-icon icon-checked"></span>全部設為已讀</a>
                            </div>
                            <!-- 通知訊息列表 -->
                                    ...
                                    <a class="notificationListBtn">
                                        <div class="notification-list-item unread">
                                            ...
                                            <div class="notification-list-content">
                                                ...
                                                <div class="notification-content">
                                                    <p>親愛的 UserName 您好: 已收到您申請之提領作業，提領單號70519001767，提領金額998元，將轉帳至您預留的銀行帳號。提領內容請您到<b>交易貨款</b>查詢。 感謝您的愛護與支持 !!</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
