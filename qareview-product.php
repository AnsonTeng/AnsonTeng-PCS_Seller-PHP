                                                        ...
                                                        <div class="table_flexBox table_flexBox-between">
                                                            ...
                                                            <div class="table_inlineBox">
                                                                <span class="list__itemInfo list_status"><i
                                                                        class="pct-btn-icon icon-alert-nofill icon-back icon-back-red"></i>未讀取</span>
                                                            </div>

                                                            <div class="date-time">
                                                                <span
                                                                    class="eng-num date-time">2018/05/28<time>01:28</time></span>
                                                            </div>
                                                        ...
                                                        <div class="productInfoGroup">
                                                            ...
                                                            <div class="productInfo-info">
                                                                ...
                                                                <div class="productInfo-info-orderNum">
                                                                    <span
                                                                        class="productInfo-info-orderNum-title">商品編號</span>
                                                                    <span
                                                                ...
                                                                <div class="productInfo-info-title">
                                                                    <span class="productInfo-info-title-text"><a
                                                                            href="#">韓版氣質V領复古大擺裙純色收腰開叉洋裝韓版氣質</a><span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td data-title="買家留言">
                                                    <div class="tableDeta-box">
                                                        <div class="buyer-messageBox">
                                                            ...
                                                            <!-- 買家留言 -->
                                                            <span class="msg-text">買二個可以算便宜一點嗎？</span>
                                                        </div>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <div class="table_flexBox table_flexBox-right table_flexBox-wrap">
                                                        <a class="pct-ui btn-xs btn-primary"
                                                            href="qareview-product-reply.php">回覆留言</a>
                                                    </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td colspan="2">
                                                    <div class="tableData-header">
                                                        ...
                                                        <div class="table_flexBox table_flexBox-between">
                                                            ...
                                                            <div class="table_inlineBox">
                                                                <span class="list__itemInfo list_status"><i
                                                                        class="pct-btn-icon icon-alert-nofill icon-back icon-back-red"></i>待回覆</span>
                                                            </div>
                                                ...
                                                <td data-title="買家留言">
                                                    <div class="tableDeta-box">
                                                        ...
                                                        <div class="buyer-messageBox">
                                                            ...
                                                            <!-- 買家留言 -->
                                                            <span class="msg-text">請問這個包有多大呢？</span>
                                                        </div>
                                            ...
                                            <tr class="table_row_bottom">
                                                <td colspan="2">
                                                    ...
                                                    <!-- 操作按鈕欄 -->
                                                    <div class="table_flexBox table_flexBox-right">
                                                        <a class="pct-ui btn-xs btn-primary"
                                                            href="qareview-product-reply.php">回覆留言</a>
                                                    </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td data-title="買家留言">
                                                    <div class="tableDeta-box">
                                                        ...
                                                        <div class="buyer-messageBox">
                                                            ...
                                                            <!-- 買家留言 -->
                                                            <span class="msg-text">請問有其他顏色可以選擇嗎？ 還有其他角度的照片嗎？
                                                                想知道內裡有幾個夾層，謝謝！</span>
                                                        </div>
                                            ...
                                            <tr class="table_row_bottom">
                                                <td colspan="2">
                                                    ...
                                                    <div class="table_flexBox table_flexBox-right">
                                                        <a class="pct-ui btn-xs btn-primary"
                                                            href="qareview-product-reply.php">留言</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
