...
<div id="pct-lightbox-printdispatch-2" class="pct-ui modal medium">
    ...
    <div class="scrolling-tall modal-content">
        <div class="description">
            ...
            <br />
            <p class="alert-atc">＊提醒您，為確保能順利送件，請遵守 Kerry 規範的包裹大小及重量限制。</p>
            <p>- 包裹大小 : 包裹長+寬+高 合計不得超過 120cm，單邊長度不得超過 60cm</p>
            <p>- 包裹重量 : 寄送包裹重量不得超過 20kg</p>
            <br />
            <p>Kerry Drop-Off Service 注意事項 : <a
                    href="https://www.pchome.co.th/info/KETH_PackagingGuideline_TH_0218.pdf">ไทย</a> / <a
                    href="https://www.pchome.co.th/info/KETH_PackagingGuideline_EN_0218.pdf">English</a></p>
        </div>
    </div>
    <div class="modal-actions">
        <a href="#" class="pct-ui btn btn-secondary">下載出貨單</a>
    </div>
</div>
