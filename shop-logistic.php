                        ...
                        <section id="pct-section-content" class="logistic-option">
                            ...
                            <div class="content-block shop-logistic-list">
                                ...
                                <div class="content-description">
                                    <p class="description-text">以下為 PChomeThai 提供的國際物流方式。</p>
                                    <p class="description-text">
                                        1.若您勾選其一為全店預設物流，每次新增商品皆會將設定該物流方式（提醒您，您選擇的物流方式也可能會無法支援寄送特定商品，上架前請仔細確認）。-若無勾選，您則需於每次上架時，為個別商品分別設定。
                                    </p>
                                    <p class="description-text">
                                        2.請依照商品包裹的重量、材積和商品分類選擇適合的物流方式，我們會依照您的設定向買家收取適當國際運費。</p>
                                                ...
                                                <div class="description-list description-list-shrink">
                                                    <div class="list-column-up">
                                                        <div class="description-list-box box-displayflex">
                                                            ...
                                                            <div class="list-box-text">
                                                                <div class="pct-ui switch-toggle">
                                                                    <input id="switch-checkbox-openlogistic-seller"
                                                                        class="switch-checkbox" type="checkbox"
                                                                        value="openseller" checked="">
                                                                    <label
                                                                        for="switch-checkbox-openlogistic-seller"></label>
                                                                </div>
                                                            </div>
                                                            <div class="list-box-text">
                                                                <div class="pct-ui switch-toggle">
                                                                    <input id="switch-checkbox-defaultlogistic-seller"
                                                                        class="switch-checkbox" type="checkbox">
                                                                    <label
                                                                        for="switch-checkbox-defaultlogistic-seller"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="description-list-box  box-displayflex">
                                                            <div class="list-box-item">物流商</div>
                                                            <div class="list-box-text"><span class="eng-num">中華郵政
                                                                    EMS</span></div>
                                                        ...
                                                        <div class="description-list-box box-displayflex">
                                                            ...
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">包裹重量為主，若材積重大於實重則取材積重計價</span></div>
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">包裹重量為主，若材積重大於實重則取材積重計價</span></div>
                                                        </div>
                                                        <div class="description-list-box  box-displayflex">
                                                        ...
                                                        <div class="description-list-box  box-displayflex">
                                                            ...
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">任一邊不超過150cm，長寬高總和不超過300cm</span>
                                                            </div>
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">任一邊不超過150cm，長寬高總和不超過210cm</span>
                                                            </div>
                                                        </div>
                                                        <div class="description-list-box  box-displayflex">
                                                        ...
                                                        <div class="description-list-box  box-displayflex">
                                                            ...
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">買家自行清關</span></div>
                                                            <div class="list-box-text"><span class="eng-num">預收關稅
                                                                    順丰代清關</span></div>
                                                        </div>
                                                        <div class="description-list-box  box-displayflex">
                                                            <div class="list-box-item">禁運項目</div>
                                                            <div class="list-box-text"><span class="eng-num"><a
                                                                        href="https://www.post.gov.tw/post/internet/Postal/index.jsp?ID=2010201#txt_AF598FA9-B75B-4450-B275-B24A94C8F4B9"
                                                                        target="_blank">查看</a></span></div>
                                                            <div class="list-box-text"><span class="eng-num"><a
                                                                        href="http://www.sf-express.com/tw/tc/dynamic_function/more/regulation/"
                                                                        target="_blank">查看</a></span></div>
                                                        </div>
                                                        <div class="description-list-box  box-displayflex">
                                                            <div class="list-box-item">出貨方式</div>
                                                            <div class="list-box-text"><span
                                                                    class="eng-num">1.賣家寄貨至PChome台北辦公室<br>2.
                                                                    連科代寄國際快捷</span></div>
                                                        ...
                                                        <div class="content-description">
                                                            ...
                                                            <p class="description-text">3. 退貨退款：PChome Thai
