    ...
    <section id="pct-main">
            ...
            <div class="container pct-gutters container-min-height">
                <div class="section-outer">
                        ...
                        <div class="col-md-9">
                            ...
                            <section id="pct-section-content">
                                ...
                                <div class="content-block">
                                   ...
                                   <p class="description-text">尺寸600px x 600px 以上享有局部放大功能，買家能看到更多商品細節 (格式限JPG, PNG, 或GIF) 
                                        ...
                                        <div id="tab-panel" class="tab-panel">
                                            <div id="thai">
                                                <div class="pct-ui form-label product-title form-m-break">
                                                    <label for="" class="required">商品名稱 <!-- Product Name--></label>
                                                ...
                                                <div class="pct-ui form-textarea-label fluid form-m-break">
                                                    <label for="" class="required">商品描述<!-- Product Intro --></label>
                                                    <div class="pct-ui form error">
                                                        <textarea placeholder="請輸入商品描述"></textarea>
                                                        <div class="error-notification-tooltip-inline">商品描述為必填且不可超過150字元</div>
                                                    </div>
                                                </div>                                   
                                                <div class="pct-ui form-label form-sm-break">
                                                    <label for="">商品規格 <!-- Product Name--></label>
                                                ...
                                                <div class="variations multiple">
                                                    ...
                                                    <p class="description-text">範例：A商品有「顏色」、「尺寸」等2種規格，規格可填寫成「紅色 > M」等。單一商品庫存數量上限為499。</p>
                                   ...
                                   <div class="content-description">
                                        <div class="pct-ui form-label product-price form-sm-break">
                                            ...
                                            <div class="column-form">
                                                <div class="pct-ui form text-with-input product-price error">
                                                    <p class="align-left required">原價 ฿</p>
                                                    <input type="text">
                                                    <div class="error-notification-tooltip-inline">商品原價有誤</div>
                                                </div>
                                        ...
                                        <div class="pct-ui form-label product-category form-lg-break">
                                            ...
                                            <div class="column-form">
                                                <div class="pct-ui form select error">
                                                    <select>
                                                    ...
                                                    <div class="error-notification-tooltip-inline">商品分類為必填</div>
                                                </div>  
                                                 <div class="pct-ui form select error">
                                                    <select>
                                                        <option value="0">請選擇</option>
                                        ...
                                        <div class="pct-ui form-label form-sm-break">
                                            <label for="">商品情況 <!--  Product Status --></label>
                                            <div class="radio-wrap">
                                                <div class="pct-ui form radio">
                                ...
                                <div class="content-block">
                                   ...
                                   <div class="content-description">
                                    ...
                                    <div class="pct-ui form-label form-m-break">
                                        ...
                                        <div class="pct-ui form product-weight unit-after error">
                                            <input type="text" placeholder="">
                                            <div class="error-notification-tooltip-inline">產品重量有誤，重量範圍為0~20公斤</div>
                                        </div>
                                    </div>
                                    <div class="pct-ui form-label volumatic">
                                        <label for="" class="required">包裹材積</label>
                                        <div class="column-form">
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                <input type="text" placeholder="長">
                                                <div class="error-notification-tooltip-inline">請輸入材積長 <!-- or 單邊數值需大於0cm --></div>
                                            </div>
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                <input type="text" placeholder="寬">
                                                <div class="error-notification-tooltip-inline">請輸入材積寬 <!-- or 單邊數值需大於0cm --></div>
                                            </div>
                                            <div class="pct-ui form product-volumatic unit-after error">
                                                <input type="text" placeholder="高">
                                                <div class="error-notification-tooltip-inline">請輸入材積高 <!-- or 單邊數值需大於0cm --></div>
                                            </div>
                                        </div>   
                                    </div> 

                                    <div class="logistic-wrap operation">
                                        <p class="description-text">已啟用物流 (有顯示為<img alt="pchome-protectiont" class="icon-img" src="https://cimg.pchome.co.th/res/other/coth/img/icon_pcprotect_badge.svg" style="width:18px;"> PChome支援物流）</p>
                                        ...
                                        <div class="pct-ui accordion">
                                            ...
                                            <div class="accordion-caption no-accordion">
                                                <div class="caption-inner">
                                                    ...
                                                    <div class="caption-title-box">
                                                        <div class="caption-title eng-num">THAI POST - Registered Mail</div>          
                                                    </div>
                                                </div>
                                                <div class="caption-text-box">
                                                       ฿ 5000
                                        ...
                                        <div class="pct-ui accordion">
                                            ...
                                            <div class="accordion-caption no-accordion">
                                                ...
                                                <div class="caption-text-box hint-text">
                                                       <div class="hint-text"><span class="pct-icon icon-alert"></span>Need to enter weight</div> 
                                                </div>
                                            </div>
                    ...
                    <div class="seller-action-bar-fixed error">
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="seller-action-bar error">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3"></div>
                                <div class="col-md-9">
